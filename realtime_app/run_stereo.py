...
from pose_app.stereo_sources import StereoCameraInput, StereoVideoSource
...
def main() -> int:
    ...
    try:
        ...
        summary["max_pair_delta_ms"] = (
            args.max_pair_delta_ms if args.left_camera is not None else None
        )
        if args.left_camera is not None and hasattr(source, "stats"):
